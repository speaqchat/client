          ...
          <div className="h-screen w-1/2 overflow-hidden flex flex-col justify-between">
            ...
            <div className="w-7/12 self-end pr-20 flex flex-col gap-2">
              ...
              <p className="tracking-tight text-sm lg:text-normal leading-[1.1]">
                ...
                Consectetur, expedita harum. Natus ab repellat explicabo
                doloribus corporis placeat animi illum!
              </p>
            </div>
            ...
            <div className="font-medium w-3/5">
              ...
              >
                ...
                <input
                  ...
                  type="text"
                  className="focus:outline-none px-3 mb-4 h-10 rounded-lg bg-secondary-dark border border-white border-opacity-10 focus:border-opacity-50 transition-[border] font-normal ease-in-out"
                />
                ...
                <input
                  ...
                  type="password"
                  className="focus:outline-none px-3 mb-8 h-10 rounded-lg bg-secondary-dark border border-white border-opacity-10 focus:border-opacity-50 transition-[border] font-normal ease-in-out"
                />
                <button
